...
<div style="margin-top: auto%">
                           ...
                           <div class="text-center " style="background: radial-gradient(circle, rg(232, 238, 233), rgb(41, 79, 184)); width:100%; height:50%;">
                             ...
                             <div class="col-md-7">
                               <p>
                                 ...
                                 <strong class="badge badge-success">{{ $photo->type }}</strong>
         ...
         <div class="row">
            ...
            @endphp
             ...
             <div class="col-12 col-md-6 col-lg-4 mb-4">
               <div class="card">
                <img class="img-responsive img-fluid rounded img-thumbnail"
                src="{{ asset('photos/' . $array[0]) }}" alt="">
                 <div class="card-body">
                   ...
                   <p class="card-text">
                     ...
                     <strong>Price:</strong> <span style="color: rgb(226, 187, 11)">{{ $photo->currency }} <strong>{{ $photo->currency }}</strong></span><br>
                     <strong>Location:</strong> {{ $photo->address }} <br>
                     <strong>Advert Type:</strong> <strong class=" badge badge-success">{{ $photo->advert}}</strong>
                   </p>
                   <form method="post" action="{{ url('detail_get') }}">
                     @csrf
    ...
    <div class="modal fade" id="edit-btn-{{ $photo->id }}" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
     ...
     <form method="post" action="{{ asset('requests') }}" style="width: 100%">
        @csrf
