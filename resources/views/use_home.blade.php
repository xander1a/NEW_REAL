 ...
 @foreach ($hot as $photo)
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-sm-7">
           ...
           @csrf
         <button class="btn btn-primary" type="submit" name="details"value="{{ $photo->name }}">Check</button>
         </form></p>
            <br>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div class="properties">
        ...
        <form action="{{ route('user_details') }}" method="post">
          @csrf
          <input type="hidden" name="names[]" value="{{ $user->id }}">
          <input type="hidden" name="names[]" value="{{ $photo->id }}">
